...
public class ChessBoard : MonoBehaviour
{
    ...
    [SerializeField] private GameObject victoryScore;
            ...
            if (Input.GetMouseButtonDown(0))
            {
                if (chessPieces[hitPosition.x, hitPosition.y] != null)
                {
                    ...
                    if ((chessPieces[hitPosition.x, hitPosition.y].team == 0 && isWhiteTurn) || (chessPieces[hitPosition.x, hitPosition.y].team == 1 && !isWhiteTurn))
                    {
                        ...
                        //Get a list of where i can go, highlight tile as well
                        availableMoves = currentlyDragging.GetAvailableMoves(ref chessPieces, TILE_COUNT_X, TILE_COUNT_Y);
                        //Get a list of special move as well
    ...
    private ChessPiece SpawnSinglePiece(chessPieceType type, int team)
    {
        ...
        //this is for adding 12 material to look good for pieces
    ...
    {
        return new Vector3(x * tileSize, yOffset, y * yOffset) - bounds + new Vector3(tileSize / 2, 0, tileSize / 2);
    }
    ...
    private void DisplayVictory(int winningTeam)
    {
        ...
        victoryScore.transform.GetChild(winningTeam).gameObject.SetActive(true);
    }

    public void OnResetButton()
    {
        //UI
        victoryScore.transform.GetChild(0).gameObject.SetActive(false);
        victoryScore.transform.GetChild(1).gameObject.SetActive(false);
        victoryScore.SetActive(false);
    ...
    private void PreventCheck()
    {
        ...
        // since we're sending ref availableMove, we will be deleting move that are putting us in check
    ...
    private void SimulateMoveForSinglePiece(ChessPiece cp, ref List<Vector2Int> moves, ChessPiece targetKing)
    {
        ...
        // Going through all the move, simualte them and check if we're in check
    ...
    private bool checkForCheckMate()
    {
        ...
        // Is the King attacking right now ?
        ...
        {
            // King is under attack, can move something to help him ?
